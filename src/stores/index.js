...
export const sportSharingAccountIdxAtom = atomWithStorage(
  "sportSharingAccountIdx",
  []
);
export const sportSharingAccountNameAtom = atomWithStorage(
  "sportSharingAccountName",
  []
);
export const sportSharingAccountNumAtom = atomWithStorage(
  "sportSharingAccountNum",
  []
);

// 모임통장 홈화면에서->친구리스트에서 리더포함 모임통장이 몇명으로 이루어져있는지 모임원 수 저장하기
export const sportSharingAccountFriendsAtom = atomWithStorage(
  "sportSharingAccountFriends",
  []
);
...
export const transferInputInfo = {
  sharingAccountIdx: "",
  amount: null,
  sender: ""
};

export const transferInputAtom = atom(transferInputInfo);
